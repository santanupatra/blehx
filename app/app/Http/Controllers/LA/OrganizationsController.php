...
class OrganizationsController extends Controller
{
	...
	//public $listing_cols = ['id', 'user_id', 'category_id', 'name', 'description', 'phone_no', 'email', 'website', 'address'];
	public $listing_cols = ['id', 'user_id', 'category_id', 'name','phone_no', 'email'];
