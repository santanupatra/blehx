    ...
    function index(Request $request)
    {
        ...
        function paysuccess(Request $request)
        {
         ...
         function donationlists()
         {
             ...
             $count_current_donations=$donations->count();
             //echo $count_current_donations; exit;
            ...
            ->map(function($item, $key)
            {
             ...
             return view('Myprojects/donate',['donations'=>$donations,'count_current_donations'=>$count_current_donations]);
