...
<section class="login-bnr" style=" background: url(../public/assets/img/bannerPhoto1.jpg) no-repeat; background-size: cover;">
	<div class="overlayPart">
      <div class="container">
        <div class="d-flex align-items-center innr">
          <div>
            <h2 class="text-white zilla_slablight font-48"><a href="#" class="projectsLove">Projects We Love <i class="icon ion-chevron-down"></i></a> <br> sorted by <a href="#" class="newest" onclick="openNav()">Newest <i class="icon ion-chevron-down"></i></a>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    <div class="container">
    	<div class="row">
    		<div class="col-lg-4 text-left ml-220px">
    		<a href="#">Magic</a>
		    <a href="#">Popularity</a>
		    <a href="#">Newest</a>
		    <a href="#">End Date</a>
		    <a href="#">Most Funded</a>
		    <a href="#">Most Backend</a>
    	</div>
    	</div>
    </div>
  </div>
