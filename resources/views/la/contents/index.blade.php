...
@section("contentheader_title", "Contents")
@section("contentheader_description", "Contents listing")
@section("section", "Contents")
@section("sub_section", "Listing")
@section("htmlheader_title", "Contents Listing")

@section("headerElems")
@la_access("Contents", "create")
...
<div class="modal fade" id="AddModal" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			{!! Form::open(['action' => 'LA\ContentsController@store', 'id' => 'content-add-form']) !!}
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/content_dt_ajax') }}",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
