...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $site_setting->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Site_Settings", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/site_settings/'.$site_setting->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Site_Settings", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.site_settings.destroy', $site_setting->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/site_settings') }}" data-toggle="tooltip" data-placement="right" title="Back to Site Settings"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'fb_link')
						@la_display($module, 'twitter_link')
						@la_display($module, 'google_plus')
						@la_display($module, 'linkedin_link')
						@la_display($module, 'youtube_link')
						@la_display($module, 'admin_email')
					</div>
				</div>
			</div>
		</div>
