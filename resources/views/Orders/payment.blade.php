    ...
    <div class="row">
        ...
        <div class="product-detail-rightdiv">
              <h3 class="h4 pay">Payment</h3>
                <div class="pay-area">
                    {!! Form::open(['url' => 'order/stripe_payment', 'method'=>'post', 'id'=>'frmstripe', 'enctype' => 'multipart/form-data']) !!}
                        <input type="hidden" name="currency_code" value="USD">
                        <input type="hidden" name="amount" id="amount" value="{{$orders->total_price}}">
