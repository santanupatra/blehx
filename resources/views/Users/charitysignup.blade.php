              ...
              <input type="hidden"  name="type" value="C">
                <div class="form-row">
                  <div class="col-12 mb-4">
                      <input type="text" class="form-control" placeholder="First name of the Charity" required name="first_name" id="first_name">
                      <small style="display:none;" id="name_error" class="text-danger">Charity name Already registered</small>
                  </div>

                  <div class="col-12 mb-4">
                      <input type="text" class="form-control" placeholder="Last name of the Charity" required name="last_name" id="last_name">
                  </div>
