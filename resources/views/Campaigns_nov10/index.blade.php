        ...
        <div class="row">
          <div class="col-lg-6 mb-2">
            <div class="d-flex align-items-center">
              ...
              <a class="mr-2 font-theme font-16 latosemibold" href="javascript:void(0)" onclick="sortby('id')">Recent Project </a>
              <a class="mr-2 font-red font-16 latosemibold" href="javascript:void(0)" onclick="sortby('avg_rateing')">Most Popular Project</a>
            </div>
          </div>
          <div class="col-lg-6">
...
<!--                      <select class="form-control form-control-sm w145 latosemibold" >
            ...
            <div>
              ...
              <div class="d-flex mt-3 mb-3">
                <div class="flex-1 d-flex align-items-center">
                  ...
                  <p class="font-14 mb-0 ml-2 font-theme">by {{$heighest_donated_campaign->user_name}}</p>
                </div>
