      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="alert alert-warning fade in" style="margin-bottom:35px;">
            ...
            <h4>Update: <?php echo e($user->updated_at); ?></h4>
      ...
      <div class="row">
        <div class="col-sm-2">
          <div class="cmg cmg-1"> <span class="fa fa-btc fa-3x"></span>
            <div class="cmc"> <b><?php echo e($user->bitcoin); ?> TH/s</b>
        ...
        <div class="col-sm-2">
          <div class="cmg cmg-2"> <span class="fa fa-cab fa-3x"></span>
            <div class="cmc"> <b><?php echo e($user->litecoin); ?> MH/s</b>
        ...
        <div class="col-sm-2">
          <div class="cmg cmg-3"> <span class="fa fa-flash fa-3x"></span>
            <div class="cmc"> <b><?php echo e($user->ethereum); ?> MH/s</b>
