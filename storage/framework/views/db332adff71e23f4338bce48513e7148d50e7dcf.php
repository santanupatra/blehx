...
<?php $__env->startSection("contentheader_title", "Site Settings"); ?>
<?php $__env->startSection("contentheader_description", "Site Settings listing"); ?>
<?php $__env->startSection("section", "Site Settings"); ?>
<?php $__env->startSection("sub_section", "Listing"); ?>
<?php $__env->startSection("htmlheader_title", "Site Settings Listing"); ?>

<?php $__env->startSection("headerElems"); ?>
<?php if(LAFormMaker::la_access("Site_Settings", "create")) { ?>
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add Site Setting</button>
<?php } ?>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Add Site Setting</h4>
			</div>
			<?php echo Form::open(['action' => 'LA\Site_SettingsController@store', 'id' => 'site_setting-add-form']); ?>
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "<?php echo e(url(config('laraadmin.adminRoute') . '/site_setting_dt_ajax')); ?>",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
	...
	$("#site_setting-add-form").validate({
