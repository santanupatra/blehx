<?php $__env->startSection('htmlheader_title', 'Module View'); ?>
...
<div id="page-content" class="profile2">
	...
	<?php endif; ?>
		<div class="col-md-4">
			<div class="row">
				<div class="col-md-3">
					<!--<img class="profile-image" src="<?php echo e(asset('/img/avatar5.png')); ?>" alt="">-->
					<div class="profile-icon text-primary"><i class="fa <?php echo e($module->fa_icon); ?>"></i></div>
				</div>
				<div class="col-md-9">
					<a class="text-white" href="<?php echo e(url(config('laraadmin.adminRoute') . '/'.$module->name_db)); ?>"><h4 data-toggle="tooltip" data-placement="left" title="Open <?php echo e($module->model); ?> Module" class="name"><?php echo e($module->label); ?></h4></a>
					<div class="row stats">
						<div class="col-md-12"><?php echo e(Module::itemCount($module->name)); ?> Items</div>
					</div>
		...
		<div class="col-md-3">
			<div class="dats1" data-toggle="tooltip" data-placement="left" title="Controller"><i class="fa fa-anchor"></i> <?php echo e($module->controller); ?></div>
			<div class="dats1" data-toggle="tooltip" data-placement="left" title="Model"><i class="fa fa-database"></i> <?php echo e($module->model); ?></div>
			<div class="dats1" data-toggle="tooltip" data-placement="left" title="View Column Name"><i class="fa fa-eye"></i>
				<?php if($module->view_col!=""): ?>
					<?php echo e($module->view_col); ?>
		...
		<div class="col-md-1 actions">
			<button module_name="<?php echo e($module->name); ?>" module_id="<?php echo e($module->id); ?>" class="btn btn-default btn-delete btn-xs delete_module"><i class="fa fa-times"></i></button>
		</div>
	</div>

	<ul id="module-tabs" data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="<?php echo e(url(config('laraadmin.adminRoute') . '/modules')); ?>" data-toggle="tooltip" data-placement="right" title="Back to Modules"> <i class="fa fa-chevron-left"></i>&nbsp;</a></li>
	...
	<div class="tab-content">
					...
					<div class="panel-body">
						...
						<tbody>														
							<?php foreach($module->fields as $field): ?>
								<tr>
									<td style="display:none;"><?php echo e($field['sort']); ?></td>
									<td><?php echo e($field['id']); ?></td>
									<td><?php echo e($field['label']); ?></td>
									<td><?php echo e($field['colname']); ?></td>
									<td><?php echo e($ftypes[$field['field_type']]); ?></td>
									<td><?php if($field['unique']): ?> <span class="text-danger">True</span><?php endif; ?> </td>
									<td><?php echo e($field['defaultvalue']); ?></td>
									<td><?php echo e($field['minlength']); ?></td>
									<td><?php echo e($field['maxlength']); ?></td>
									...
									<td>
										<a href="<?php echo e(url(config('laraadmin.adminRoute') . '/module_fields/'.$field['id'].'/edit')); ?>" class="btn btn-edit-field btn-warning btn-xs" style="display:inline;padding:2px 5px 3px 5px;" id="edit_<?php echo e($field['colname']); ?>"><i class="fa fa-edit"></i></a>
										<a href="<?php echo e(url(config('laraadmin.adminRoute') . '/module_fields/'.$field['id'].'/delete')); ?>" class="btn btn-edit-field btn-danger btn-xs" style="display:inline;padding:2px 5px 3px 5px;" id="delete_<?php echo e($field['colname']); ?>"><i class="fa fa-trash"></i></a>
										<?php if($field['colname'] != $module->view_col): ?>
											<a href="<?php echo e(url(config('laraadmin.adminRoute') . '/modules/'.$module->id.'/set_view_col/'.$field['colname'])); ?>" class="btn btn-edit-field btn-success btn-xs" style="display:inline;padding:2px 5px 3px 5px;" id="view_col_<?php echo e($field['colname']); ?>"><i class="fa fa-eye"></i></a>
										<?php endif; ?>
									</td>
								</tr>
							<?php endforeach; ?>
		...
		<div role="tabpanel" class="tab-pane fade in p20 bg-white" id="tab-access">
			...
			<form action="<?php echo e(url(config('laraadmin.adminRoute') . '/save_role_module_permissions/'.$module->id)); ?>" method="post">
				...
				<table class="table table-bordered dataTable no-footer table-access">
					...
					<?php foreach($roles as $role): ?>
						<tr class="tr-access-basic" role_id="<?php echo e($role->id); ?>">
							<td><input class="role_checkb" type="checkbox" name="module_<?php echo e($role->id); ?>" id="module_<?php echo e($role->id); ?>" checked="checked"> <?php echo e($role->name); ?></td>
							
							<td><input class="view_checkb" type="checkbox" name="module_view_<?php echo e($role->id); ?>" id="module_view_<?php echo e($role->id); ?>" <?php if($role->view == 1) { echo 'checked="checked"'; } ?> ></td>
							<td><input class="create_checkb" type="checkbox" name="module_create_<?php echo e($role->id); ?>" id="module_create_<?php echo e($role->id); ?>" <?php if($role->create == 1) { echo 'checked="checked"'; } ?> ></td>
							<td><input class="edit_checkb" type="checkbox" name="module_edit_<?php echo e($role->id); ?>" id="module_edit_<?php echo e($role->id); ?>" <?php if($role->edit == 1) { echo 'checked="checked"'; } ?> ></td>
							<td><input class="delete_checkb" type="checkbox" name="module_delete_<?php echo e($role->id); ?>" id="module_delete_<?php echo e($role->id); ?>" <?php if($role->delete == 1) { echo 'checked="checked"'; } ?> ></td>
							<td>
								<a role_id="<?php echo e($role->id); ?>" class="toggle-adv-access btn btn-default btn-sm hide_row"><i class="fa fa-chevron-down"></i></a>
							</td>
						</tr>
						<tr class="tr-access-adv module_fields_<?php echo e($role->id); ?> hide" role_id="<?php echo e($role->id); ?>" >
							<td colspan=6>
								<table class="table table-bordered">
								<?php foreach(array_chunk($module->fields, 3, true) as $fields): ?>
									<tr>
										<?php foreach($fields as $field): ?>
											<td><div class="col-md-3"><input type="text" name="<?php echo e($field['colname']); ?>_<?php echo e($role->id); ?>" value="<?php echo e($role->fields[$field['id']]['access']); ?>" data-slider-value="<?php echo e($role->fields[$field['id']]['access']); ?>" class="slider form-control" data-slider-min="0" data-slider-max="2" data-slider-step="1" data-slider-orientation="horizontal"  data-slider-id="<?php echo e($field['colname']); ?>_<?php echo e($role->id); ?>"></div> <?php echo e($field['label']); ?> </td>
										<?php endforeach; ?>
									</tr>
								<?php endforeach; ?>
								</table>
			...
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-3">
					<ul id="sortable_module_fields">
						<?php foreach($module->fields as $field): ?>
							<li class="ui-field" field_id="<?php echo e($field['id']); ?>"><span class="ui-icon ui-icon-arrowthick-2-n-s"></span><?php echo e($field['label']); ?>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Add <?php echo e($module->model); ?> Field</h4>
			</div>
			<?php echo Form::open(['route' => config('laraadmin.adminRoute') . '.module_fields.store', 'id' => 'field-form']); ?>
				...
				<div class="box-body">
					...
					<div id="unique_val">
						<div class="form-group">
							...
							<?php echo e(Form::checkbox("unique", "unique", false, [])); ?>
					...
					<div id="length_div">
						<div class="form-group">
							...
							<?php echo e(Form::number("minlength", null, ['class'=>'form-control', 'placeholder'=>'Minimum Value'])); ?>

						</div>
						
						<div class="form-group">
							<label for="maxlength">Maximum :</label>
							<?php echo e(Form::number("maxlength", null, ['class'=>'form-control', 'placeholder'=>'Maximum Value'])); ?>
					...
					<div class="form-group">
						...
						<?php echo e(Form::checkbox("required", "required", false, [])); ?>
					...
					<div class="form-group">
						...
						<?php /* Form::text("popup_vals", null, ['class'=>'form-control', 'placeholder'=>'Popup Values (Only for Radio, Dropdown, Multiselect, Taginput)']) */ ?>
					</div>
					-->
					...
					<div class="form-group values">
						...
						<div class="radio" style="margin-bottom:20px;">
							<label><?php echo e(Form::radio("popup_value_type", "table", true)); ?> From Table</label>
							<label><?php echo e(Form::radio("popup_value_type", "list", false)); ?> From List</label>
						</div>
						<?php echo e(Form::select("popup_vals_table", $tables, "", ['id'=>'popup_vals_table', 'class'=>'form-control', 'rel' => ''])); ?>
...
<script src="<?php echo e(asset('la-assets/plugins/jQueryUI/jquery-ui.js')); ?>"></script>
...
$(function () {
	...
	$("#sortable_module_fields").sortable({
		update: function(event, ui) {
			...
			$.ajax({
				url: "<?php echo e(url(config('laraadmin.adminRoute') . '/save_module_field_sort')); ?>/"+<?php echo e($module->id); ?>,
	...
	$("#generate_migr").on("click", function() {
		...
		$fa.addClass("fa-spin");
		$.ajax({
			url: "<?php echo e(url(config('laraadmin.adminRoute') . '/module_generate_migr')); ?>/"+<?php echo e($module->id); ?>,
			method: 'GET',
			success: function( data ) {
	...
	$("#generate_update").on("click", function() {
		...
		$fa.addClass("fa-spin");
		$.ajax({
			url: "<?php echo e(url(config('laraadmin.adminRoute') . '/module_generate_update')); ?>/"+<?php echo e($module->id); ?>,
			method: 'GET',
			success: function( data ) {
				$fa.removeClass("fa-refresh");
				$fa.removeClass("fa-spin");
	...
	$("#generate_migr_crud").on("click", function() {
		...
		$fa.addClass("fa-spin");
		$.ajax({
			url: "<?php echo e(url(config('laraadmin.adminRoute') . '/module_generate_migr_crud')); ?>/"+<?php echo e($module->id); ?>,
			method: 'GET',
			success: function( data ) {
				$fa.removeClass("fa-refresh");
				$fa.removeClass("fa-spin");
