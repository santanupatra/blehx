...
<?php $__env->startSection("contentheader_title", "Faqs"); ?>
<?php $__env->startSection("contentheader_description", "Faqs listing"); ?>
<?php $__env->startSection("section", "Faqs"); ?>
<?php $__env->startSection("sub_section", "Listing"); ?>
<?php $__env->startSection("htmlheader_title", "Faqs Listing"); ?>

<?php $__env->startSection("headerElems"); ?>
<?php if(LAFormMaker::la_access("Faqs", "create")) { ?>
...
<div class="modal fade" id="AddModal" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<?php echo Form::open(['action' => 'LA\FaqsController@store', 'id' => 'faq-add-form']); ?>
			...
			<div class="modal-body">
				<div class="box-body">
					...
					<?php echo LAFormMaker::input($module, 'faq_category_id'); ?>
					*/ ?>
				</div>
			</div>
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "<?php echo e(url(config('laraadmin.adminRoute') . '/faq_dt_ajax')); ?>",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
