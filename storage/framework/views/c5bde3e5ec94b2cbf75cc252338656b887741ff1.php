...
<div class="modal fade" id="AddModal" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<?php echo Form::open(['action' => 'LA\ProductsController@store', 'id' => 'product-add-form', 'enctype' => 'multipart/form-data']); ?>
			...
			<div class="modal-body">
				<div class="box-body">
					...
					<?php echo LAFormMaker::input($module, 'payment'); ?>
					<?php echo LAFormMaker::input($module, 'overview'); ?>
					<?php echo LAFormMaker::input($module, 'warranty'); ?>
					*/ ?>
