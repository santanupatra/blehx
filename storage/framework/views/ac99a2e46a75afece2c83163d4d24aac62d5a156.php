...
<header class="main-header">
	...
	<a href="<?php echo e(url(config('laraadmin.adminRoute'))); ?>" class="logo">
		...
		<span class="logo-lg"><b><?php echo e(LAConfigs::getByKey('sitename_part1')); ?></b></span>
	</a>
	<?php endif; ?>
	...
	<?php if(LAConfigs::getByKey('layout') == 'layout-top-nav'): ?>
		<div class="container">
			<div class="navbar-header">
				<a href="<?php echo e(url(config('laraadmin.adminRoute'))); ?>" class="navbar-brand"><b><?php echo e(LAConfigs::getByKey('sitename_part1')); ?></a>
