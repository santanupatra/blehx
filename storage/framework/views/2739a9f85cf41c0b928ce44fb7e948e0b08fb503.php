...
<style type="text/css">
      .loader {
          ...
          height: 100%;
          z-index: 9999;
          background: url('<?php echo e(URL::asset('assets/img/pageLoader.gif')); ?>') 50% 50% no-repeat rgb(255,255,255);
          opacity: 1;
      }       
  </style>
...
<div id="wowslider-container1">
  <div class="ws_images">
    <ul>
      <li><img src="<?php echo e(URL::asset('assets/img/s.jpg')); ?>"  id="wows1_0"/></li>
      <li><img src="<?php echo e(URL::asset('assets/img/s1.jpg')); ?>" id="wows1_1"/></li>
    </ul>
  </div>
</div>
<div class="clearfix"></div>
    ...
    <div class="row">
      ...
      <div class="col-md-5">
        <div class="product-imgdiv">
          <img src="<?php echo e(URL::asset('assets/img/p1.png')); ?>" alt="" class="img-responsive center-block">
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="offer-div">
          ...
          <div class="media">
            <div class="media-left">
              <a href="#">
                <img class="media-object img-circle" src="<?php echo e(URL::asset('assets/img/m1.jpg')); ?>" alt="">
              </a>
            </div>
          ...
          <div class="media">
            <div class="media-left">
              <a href="#">
                <img class="media-object img-circle" src="<?php echo e(URL::asset('assets/img/m2.jpg')); ?>" alt="">
              </a>
            </div>
            <div class="media-body">
          ...
          <div class="media">
            <div class="media-left">
              <a href="#">
                <img class="media-object img-circle" src="<?php echo e(URL::asset('assets/img/m3.jpg')); ?>" alt="">
              </a>
            </div>
            <div class="media-body">
          ...
          <div class="media">
            <div class="media-left">
              <a href="#">
                <img class="media-object img-circle" src="<?php echo e(URL::asset('assets/img/m4.jpg')); ?>" alt="">
              </a>
            </div>
            <div class="media-body">
      ...
      <div class="col-md-5">
        <div class="whychoose-div">
          ...
          <div class="whyimg-div">
            <img src="<?php echo e(URL::asset('assets/img/blx.png')); ?>" alt="" class="img-responsive center-block img-circle">
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="service-div">
        <div class="col-md-4">
          <div class="thumbnail">
              <img src="<?php echo e(URL::asset('assets/img/b1.jpg')); ?>" alt="" class="img-responsive center-block">
              <div class="caption">
        ...
        <div class="col-md-4">
          <div class="thumbnail">
              <img src="<?php echo e(URL::asset('assets/img/b2.jpg')); ?>" alt="" class="img-responsive center-block">
              <div class="caption">
        ...
        <div class="col-md-4">
          <div class="thumbnail">
              <img src="<?php echo e(URL::asset('assets/img/b3.jpg')); ?>" alt="" class="img-responsive center-block">
              <div class="caption">
      ...
      <div class="datacenter-div">
        ...
        <div class="col-md-4">
          <div class="datacenter-imgdiv">
            <img src="<?php echo e(URL::asset('assets/img/Two-mobiles.png')); ?>" alt="" class="img-responsive center-block">
          </div>
        </div>
