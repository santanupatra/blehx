...
<?php $__env->startSection("contentheader_title", "Faq Categories"); ?>
<?php $__env->startSection("contentheader_description", "Faq Categories listing"); ?>
<?php $__env->startSection("section", "Faq Categories"); ?>
<?php $__env->startSection("sub_section", "Listing"); ?>
<?php $__env->startSection("htmlheader_title", "Faq Categories Listing"); ?>

<?php $__env->startSection("headerElems"); ?>
<?php if(LAFormMaker::la_access("Faq_Categories", "create")) { ?>
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add Faq Category</button>
<?php } ?>
...
<div class="modal fade" id="AddModal" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<?php echo Form::open(['action' => 'LA\Faq_CategoriesController@store', 'id' => 'faq_category-add-form']); ?>
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "<?php echo e(url(config('laraadmin.adminRoute') . '/faq_category_dt_ajax')); ?>",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
	...
	$("#faq_category-add-form").validate({
