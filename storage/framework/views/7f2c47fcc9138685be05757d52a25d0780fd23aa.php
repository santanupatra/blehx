	...
	<div class="box-body">
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<?php echo Form::model($product, ['route' => [config('laraadmin.adminRoute') . '.products.update', $product->id ], 'method'=>'PUT', 'id' => 'product-edit-form', 'enctype' => 'multipart/form-data']); ?>
					...
					*/ ?>
					<div class="form-group"><label for="image" style="display:block;">Image* :</label>
					 ...
					 <img src="<?php echo e(URL::asset('../storage/uploads/product/')); ?>/<?php echo e($product->image); ?>" alt="" width="150">	
					</div>
                    <br>
