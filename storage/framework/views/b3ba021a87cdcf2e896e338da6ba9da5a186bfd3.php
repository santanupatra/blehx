        ...
        <div class="row justify-content-md-center">
          <div class="col-lg-4 ">
            ...
            <div class="text-center font-12">
              <p class="m-0 font-theme">Have an account? <a href="<?php echo e(URL::asset('/')); ?>user/signin" class="font-theme">Log in</a></p>
              <hr class="mb-3 mt-3">
            </div>
...
<script type="text/javascript">
   ...
   $("#emailinput").keyup(function(){
    ...
    {
        $.get("<?php echo e(URL::asset('/')); ?>checkemail/"+email,function(data){
        if(data.Ack==1)
        {
            $("#email_error").fadeOut();
